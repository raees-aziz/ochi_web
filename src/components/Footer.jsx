...
function Footer() {
    return (
        <div className='flex w-full h-screen bg-zinc-900 p-20'>
            <div className='w-1/2 h-full flex flex-col justify-between font-["Founders Grotesk"]'>
                <div className='heading'>
                    <h1 className='text-[8vh] uppercase leading-none font-semibold'>Eye-</h1>
                    <h1 className='text-[8vh] uppercase leading-none font-semibold'>Opening</h1>
            ...
            <div className='w-1/2'>
                <h1 className='uppercase text-[5vw] font-["Founders Grotesk"] font-semibold leading-none'>Presentation</h1>
                <div className='details font-["Neue Montreal"] mt-20'>
                    {["Facebook", "Instagram", "Twitter"].map((item, index) => (
                        <a key={index} className='text-3xl block ' href="">{item}</a>
                    ))}
